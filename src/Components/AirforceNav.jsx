...
export const AirforceNav = () => {
  const AirforceItems = FeaturedItems.filter((item) => item.type === "airforce");
  ...
  return (
    <>
      ...
      <div className={`${styles.bg}`}>
        <h1 className={`${styles.FeatHead}`}>Airforce</h1>
        <div className={`${styles.FeatProducts}`}>
          {AirforceItems.map((item) => {
